...
4. **Review and fix** — `/code-review medium --fix` over the fix round, then re-run the tests.
5. **Report completion**, then **Ship + PR** with `PR_HANDLING=update`, then **Teardown**.
